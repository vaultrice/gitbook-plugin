        ...
        <block>
          <card title='Vaultrice Voting Widget Configuration'>
            <vstack>
              <card title='General'>
                <vstack>
                  ...
                  <hstack>
                    ...
                    <textinput
                      state='ttl'
                      placeholder='Time to live in ms'
                    />
              ...
              <card title='Choices' hint='Provide a JSON array of choices, each with `id` and `label`.'>
                <codeblock
                  state='choices'
